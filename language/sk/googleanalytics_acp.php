...
$lang = array_merge($lang, array(
	...
	'ACP_GOOGLEANALYTICS_ID_EXPLAIN'	=> 'Vložte váš kód Google Analytics ID, napr.: <samp>UA-000000-00</samp> or Measurement ID <samp>G-XXXXXXXXXX</samp>.<br /><br />Google Analytics môže sledovať vašich zaregistrovaných používateľov naprieč viacerými zariadeniami a sedeniami, aby ste mali vo vašich hláseniach presnejšie počty používateľov. Aby ste túto rozšírenú funkcionalitu aktivovali, musíte nastaviť sledovanie User ID vo vašom účte Google Analytics. <a href="https://support.google.com/analytics/answer/3123666">Kliknite pre viac informácií <i class="fa-arrow-up-right-from-square fas fa-fw" aria-hidden="true"></i></a>.',
	'ACP_GOOGLEANALYTICS_ID_INVALID'	=> '“%s” nie je platný kód Google Analytics ID.<br />Mal by mať tvar “UA-000000-00” or “G-XXXXXXXXXX”.',
