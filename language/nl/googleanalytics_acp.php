...
$lang = array_merge($lang, array(
	...
	'ACP_GOOGLEANALYTICS_ID_EXPLAIN'	=> 'Plaats hier je Google Analytics ID code, bijv: <samp>UA-000000-00</samp> or Measurement ID <samp>G-XXXXXXXXXX</samp>.<br><br>Google Analytics kan je geregistreerde gebruikers volgen over meerdere apparaten en sessies voor betere gebruikersaantallen in je rapportages. Om deze verbeterde functionaliteit in te schakelen dien je de functie User-ID te configureren in je Google Analytics-account. <a href="https://support.google.com/analytics/answer/3123666">Klik hier voor meer informatie <i class="fa-arrow-up-right-from-square fas fa-fw" aria-hidden="true"></i></a>.',
	'ACP_GOOGLEANALYTICS_ID_INVALID'	=> '“%s” is geen geldige Google Analytics ID code.<br>Het moet iets zijn in de vorm van “UA-000000-00” or “G-XXXXXXXXXX”.',
