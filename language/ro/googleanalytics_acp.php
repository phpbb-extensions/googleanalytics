...
$lang = array_merge($lang, array(
	...
	'ACP_GOOGLEANALYTICS_ID_EXPLAIN'	=> 'Scrie codul tau Google Analytics de urmarire, ex: <samp>G-XXXXXXXXXX</samp>.<br><br>Google Analytics poate urmări utilizatorii înregistrați pe mai multe dispozitive și sesiuni, pentru un număr de utilizator mai precise în rapoarte. Pentru a activa această funcționalitate îmbunătățită de utilizare ID-ul de urmărire trebuie să fie configurat în contul dvs. Google Analytics. <a href="https://support.google.com/analytics/answer/9213390" target="_blank">Click pentru mai multe informații <i class="icon fa-external-link fa-fw" aria-hidden="true"></i></a>.',
